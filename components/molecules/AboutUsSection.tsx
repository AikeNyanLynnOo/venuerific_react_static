          ...
          <div className="w-full">
            <div className="px-5 md:px-16 lg:px-20  max-w-screen-2xl mx-auto">
              ...
              <p className="mt-4 text-secondary-600 w-full mx-auto lg:mx-0 leading-relaxed">
                ...
                struggling with high manpower costs and rental rates in
                Singapore.
                <br />
                <br />
                What started as a thought-provoking question, “What if?” has
                grown into Asia&apos;s largest platform for event planners and
                venue owners, transforming the way people find, plan and book
                venues. From the Guoco Midtown Network Hub to the iconic Mandala
                Club, our platform simplifies venue discovery and booking with
                just a few clicks.
                <br />
                <br />
                Today, we empower thousands of venue owners & event vendors
                across Singapore, Malaysia, Hong Kong, the Philippines, and
                Indonesia to drive their growth and boost their ability to
                ...
                <br />
                <br />
                At Venuerific, we&apos;re more than just a technology and
                software company. We&apos;re a dedicated team passionate about
                bringing people and venues together and transforming every event
