...
import { MapIframe } from "@/components/maps/MapIframe";
import { useVenueRoomDetailStore } from "@/store/venue-room-detail-store";
import { COLORS } from "@/styles/colors";

interface VenueRoomDetailInfoTabsProps {
  roomId: any;
  packageId: any;
  setPackageId: any;
...
export const VenueRoomDetailInfoTabs = ({
  roomId,
  packageId,
  setPackageId,
  handleRoomChangeWithValue,
}: VenueRoomDetailInfoTabsProps) => {
  ...
  const { venue_room, current_user, setRoomFavourite } =
  ...
  // When user click select this package
