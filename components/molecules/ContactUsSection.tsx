  ...
  return (
    <section className="mt-[81px] w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="bg-white p-0 lg:pr-16">
            ...
            <p className="text-secondary-600 mb-4">
              Whether you&apos;re looking to grow your venue or event services,
              find the perfect venue or explore partnership opportunities,
              we&apos;d love to hear from you.
            </p>
      ...
      <div className="mt-16 bg-primary-800 text-white w-full max-w-screen-2xl mx-auto py-20 px-4 md:px-5 lg:px-12 xl:px-20">
        <h2 className="text-2xl font-bold mb-4 hidden lg:block">Our Offices</h2>
        <p className="text-primary-200 hidden lg:block">
          We are present in 5 countries in Asia to transform the event planning
          experience.
        </p>
        ...
        <div className="flex gap-x-5 items-start mt-10 justify-between">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full">
            ...
            <div>
              ...
              <p className="text-primary-200">
                Lippo St. Moritz Tower Floor #09-01 Jl. Puri Raya Blok U1, Puri
                Indah 11610, Jakarta Barat, RT.11/RW.7, Kembangan Selatan,
                Kembangan, DKI Jakarta, Jakarta 11610
              </p>
            </div>
            {/* Philippines */}
            <div>
              ...
              <p className="text-primary-200">
                1104 Landsdale Tower, Sct. Rallos St, Quezon City, Metro Manila,
                Philippines
              </p>
            </div>
          </div>
