...
const TalkBannerVendor = () => {
  return (
    <div className="relative w-full h-[215px] md:h-[300px]">
      <div className="absolute bottom-0 w-full h-1/2 md:h-1/2 translate-y-1/2 bg-gradient-to-r from-[#211A4C] to-[#323081] z-0"></div>
