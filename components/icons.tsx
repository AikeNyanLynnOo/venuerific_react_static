...
export const SGFlag: React.FC<IconSvgProps> = (props) => {
  return (
    <svg
...
export const MYFlag: React.FC<IconSvgProps> = (props) => {
  return (
    <svg
      className={props.className}
      height={props.height || 20}
...
export const IndoFlag: React.FC<IconSvgProps> = (props) => {
  return (
    <svg
      className={props.className}
      height={props.height || 20}
...
export const PhipFlag: React.FC<IconSvgProps> = (props) => {
  return (
    <svg
      className={props.className}
      height={props.height || 20}
...
export const HongKongFlag: React.FC<IconSvgProps> = (props) => {
  return (
    <svg
      className={props.className}
      height={props.height || 20}
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <rect fill="#db362f" height="24" rx="4" ry="4" width="30" x="1" y="4" />
      <path
        d="M27,4H5c-2.209,0-4,1.791-4,4V24c0,2.209,1.791,4,4,4H27c2.209,0,4-1.791,4-4V8c0-2.209-1.791-4-4-4Zm3,20c0,1.654-1.346,3-3,3H5c-1.654,0-3-1.346-3-3V8c0-1.654,1.346-3,3-3H27c1.654,0,3,1.346,3,3V24Z"
        opacity=".15"
      />
