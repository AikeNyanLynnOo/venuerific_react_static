...
export const ContactUsLayout = ({ headerFooterRes }: ContactUsSectionProps) => {
      ...
      <section className="mt-[81px]">
        <div className="w-full mx-auto px-0 md:px-5 lg:px-12 xl:px-20">
          <div className="px-4 md:px-0 my-10 md:mt-4 max-w-screen-2xl mx-auto">
            <div className="py-12 2xl:pl-0 w-full max-w-screen-2xl mx-auto">
              {/* Contact Us Title */}
        ...
        {/* Our offices */}
        <div className="mt-16 bg-primary-800 text-white w-full mx-auto px-0 md:px-5 lg:px-12 xl:px-20 py-20">
          <div className="px-4 md:px-0 my-10 md:mt-4 max-w-screen-2xl mx-auto">
