...
const SuperVenueRaiseStatus = () => {
  return (
    <div className="mt-0 md:mt-14 lg:mt-4 w-full mx-auto px-0 md:px-5 lg:px-12 xl:px-20 py-6 lg:py-10 bg-primary-50 lg:bg-secondary-50">
      <div className="px-4 md:px-0 my-0 md:my-0 lg:my-10 md:mt-4 max-w-screen-2xl mx-auto flex flex-col lg:flex-row items-center gap-10 lg:gap-28">
