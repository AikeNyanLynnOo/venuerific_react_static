  ...
  return (
    <div className="mt-[81px] w-full mx-auto px-0 md:px-5 lg:px-12 xl:px-20 py-20 lg:py-28 bg-white">
      <div className="px-4 md:px-0 my-10 md:mt-6 max-w-screen-2xl mx-auto text-center">
        <p className="text-primary-600 text-[16px] font-semibold mb-2">
          New Feature
        </p>

        <h1 className="text-secondary-900 text-[36px] md:text-[48px] font-bold mb-6 max-w-3xl mx-auto">
          Super Venue Program is Now Live!
        </h1>

        <p className="text-secondary-600 text-[18px] md:text-[20px] max-w-2xl mx-auto">
