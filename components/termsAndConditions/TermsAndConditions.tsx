  ...
  return (
    <div className="mt-[81px] w-full mx-auto px-0 md:px-5 lg:px-12 xl:px-20 py-10">
      <div className="px-4 md:px-0 my-10 md:mt-6 max-w-screen-2xl mx-auto w-[60%]">
        ...
        {/* Terms Paragraph 1 */}
        <section>
          <p className="text-secondary-600 text-[18px] mt-32 text-left">
        ...
        {/* Terms Paragraph 2 */}
        <section>
          <p className="text-secondary-600 text-[18px] mt-6 text-left">
        ...
        <section>
          <h2 className="text-secondary-900 text-[30px] font-semibold mt-10 text-left">
            What information do we collect?
          </h2>
          <p className="text-secondary-600 text-[18px] mt-6 text-left">
        ...
        {/* Key Points List */}
        <section>
          <ul className="list-decimal ml-6 text-secondary-600 text-[18px] mt-6">
